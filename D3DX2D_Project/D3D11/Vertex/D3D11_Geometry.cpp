...
{
	//geometry.AddVertex(D3D11_VertexTexture(D3DXVECTOR3(-0.5f, -0.5f, 0.0f), D3DXVECTOR2(0.0f, 0.5f)));
	//geometry.AddVertex(D3D11_VertexTexture(D3DXVECTOR3(-0.5f, +0.5f, 0.0), D3DXVECTOR2(0.0f, 0.0f)));
	//geometry.AddVertex(D3D11_VertexTexture(D3DXVECTOR3(0.5f, -0.5f, 0.0f), D3DXVECTOR2(0.5f, 0.5f)));
	//geometry.AddVertex(D3D11_VertexTexture(D3DXVECTOR3(0.5f, 0.5f, 0.0f), D3DXVECTOR2(0.5f, 0.0f)));
